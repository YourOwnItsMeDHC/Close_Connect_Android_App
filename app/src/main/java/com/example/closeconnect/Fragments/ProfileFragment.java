...
import com.example.closeconnect.Adapter.FollowersAdapter;
import com.example.closeconnect.Model.Follow;
import com.example.closeconnect.R;
import com.example.closeconnect.User;
import com.example.closeconnect.databinding.FragmentProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 11) {
            ...
            if (data.getData() != null) {
                Uri uri = data.getData();
                binding.diagonalImage.setImageURI(uri);
